...
$application->registerRoutes($this, [
	'routes' => [
        ...
        /*---  2018-3-13 tianquanjun  get登录  start  ---*/
        ['name' => 'login#tryLoginGet', 'url' => '/login/{user}/{password}', 'verb' => 'GET'],
        /*---  2018-3-13 tianquanjun  get登录  end  ---*/
        ...
        /*---  2018-3-20 tianquanjun  组织结构  start  ---*/
        ['name' => 'popDepartment#getDepart', 'url' => '/popdepartment/getDepart', 'verb' => 'GET'],
        /*---  2018-3-20 tianquanjun  组织结构  start  ---*/
	],
	'ocs' => [
