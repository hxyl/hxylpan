...
class OC {
	...
	public static function init() {
		...
		\OC::$server->getDepartmentManager()->addBackend(new \OC\Department\Database());
    ...
    /******************** check userNumber 2016/05/26 jiangzhe add start **********************/
    /**
     * check certificate.
     * @return bool|void
     */
    protected static function chkCerInfo(&$error) {
        /******************** modify url login 2016/08/19 jiangzhe add start **********************/
        ...
        /******************** modify url login 2016/08/19 jiangzhe add end **********************/
        ...
        if(time() > OC_Util::getValidToTime()){
            $error[] = 'certificateexpired';
            return false;
        }

        if(intval(OC_User::getUserNum()["Database"]) > OC_Util::getOnlineNum()){
            $error[] = 'outmaxusernumber';
            return false;
        }
        return true;
    }
    /******************** check userNumber  2016/05/26 jiangzhe add end **********************/
