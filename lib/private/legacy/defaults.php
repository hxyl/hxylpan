...
class OC_Defaults {
	...
	public function __construct() {
		...
		/*--- 2018-3-12  tianquanjun  修改标题、链接  start ---*/

		$this->defaultEntity = '云盘'; /* e.g. company name, used for footers and copyright notices */
		$this->defaultName = '云盘'; /* short name, used when referring to the software */
		$this->defaultTitle = '云盘'; /* can be a longer name, for titles */
		$this->defaultBaseUrl = 'http://www.hxyl.com.cn';
		$this->defaultSyncClientUrl = 'http://www.hxyl.com.cn/install/#install-clients';
		$this->defaultiOSClientUrl = 'http://www.hxyl.com.cn/us/app/nextcloud/id1125420102?mt=8';
        ...
        /*--- 2018-3-12  tianquanjun  修改标题、链接  end ---*/
