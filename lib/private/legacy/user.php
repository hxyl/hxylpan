...
class OC_User {
     ...
     * get the user count.
     *
     * @return integer|bool count or false
     */
    public static function getUserNum() {
        return \OC::$server->getUserManager()->countUsers();
    }
    /******************** check userNumber  2016/05/26 jiangzhe add end **********************/
    /**--------------------------------2016-07-11 jiangzhe 增加部门共享 start--------------------------------*/
    /**
     * get the user EmployeeId.
     *
     * @return integer|bool count or false
     */
    public static function getEmployeeId($uid) {
        return \OC::$server->getUserManager()->getEmployeeId($uid);
    }
