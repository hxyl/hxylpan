<table id="userlist" class="hascontrols grid" data-groups="<?php p($_['allGroups']);?>">
    ...
    <tr>
        ...
        <?php endif;?>
        <th id="headerDepartAdmins" scope="col"><?php p($l->t('Department Admin for')); ?></th>
    ...
    <tr style="display:none">
        ...
        <td class="department">
            <select class="department-admin" >
                <option value='departAdmminYes'>
                    <?php p($l->t('Yes'));?>
                </option>
                <option value='departAdmminNo'>
                    <?php p($l->t('No'));?>
                </option>
            </select>
        </td>
