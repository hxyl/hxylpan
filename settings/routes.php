...
$application->registerRoutes($this, [
	'resources' => [
        ...
        'department' => ['url' => '/settings/department/department']
	],
	'routes' => [
        ...
        ['name' => 'Department#setDepartName', 'url' => '/settings/department/{departname}/departName', 'verb' => 'POST'],
...
$this->create('settings_department', '/settings/department')
    ->actionInclude('settings/department.php');
